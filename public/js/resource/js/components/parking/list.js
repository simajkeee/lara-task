(self["webpackChunk"] = self["webpackChunk"] || []).push([["resource/js/components/parking/list"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getParking: function getParking(page) {
      var _this = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _this.axios.get("/api/parking?page=".concat(page)).then(function (_ref) {
                  var data = _ref.data;
                  _this.parking = data;
    ...
    deleteParking: function deleteParking(id) {
      var _this2 = this;

      if (confirm("Are you sure to delete this parking spot ?")) {
        this.axios["delete"]("/api/parking/".concat(id)).then(function (response) {
          _this2.getParking();
        ...
        _c("div", { staticClass: "card-body" }, [
          _c("div", { staticClass: "table-responsive" }, [
            _c("table", { staticClass: "table table-bordered" }, [
              _vm._m(1),
              _vm._v(" "),
              _vm.parking.data.length > 0
                ? _c(
                    "tbody",
                    [
                      _vm._l(_vm.parking.data, function(parking_spot, key) {
                        return _c("tr", { key: key }, [
                          _c("td", [_vm._v(_vm._s(parking_spot.id))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(parking_spot.price))]),
                          _vm._v(" "),
                          _c(
                            "td",
                            [
                                ...
                                "button",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.deleteParking(parking_spot.id)
                                    }
                                  }
                                },
                                [_vm._v("Delete")]
                      ...
                      _vm._v(" "),
                      _c("pagination", {
                        attrs: { data: _vm.parking },
                        on: { "pagination-change-page": _vm.getParking }
                      })
                    ],
                    2
                  )
